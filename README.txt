In here you will find the BASIC program for a drawing used on
http://reddit.com/r/RetroBattlestations. The program was intended to
be reasonably portable to many different BASIC flavors. The graphics
have been encoded in a vector format and are scaled to the screen
size. Routines for drawing lines and elliptical arcs have been put
into small subroutines.
